package com.rbugarin.lecturadeassets
...
class MainActivity : AppCompatActivity() {
    ...
    private fun readContents() = assets.list("Contenidos")?.map {file ->
        assets.open("Contenidos/$file").bufferedReader().use(BufferedReader::readText)
    }?.toList()
}